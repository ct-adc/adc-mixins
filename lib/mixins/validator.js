...
module.exports = require("ct-utility");
...
var LIBRARY            = __webpack_require__(25)
  ...
  , microtask          = __webpack_require__(52)()
  , PROMISE            = 'Promise'
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_keys__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_keys___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_keys__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ct_utility__ = __webpack_require__(36);
            ...
            validation: function validation() {
                ...
                inputs.map(function (input) {
                    ...
                    if (typeof ops[input]['shouldBeVerified'] === 'function') {
                        ...
                        shouldBeVerified = __WEBPACK_IMPORTED_MODULE_3_ct_utility___default.a.base.getObjValByKey(that, ops[input]['shouldBeVerified']);
                    }
                    ...
                    if (that.formTouched[input] && shouldBeVerified) {
                        ...
                        var notAllOk = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_keys___default()(result[input]).filter(function (rule) {
                            return !result[input][rule];
                        }).length > 0;
                        result[input]._pass = !notAllOk;
                    } else if (!shouldBeVerified) {
                        var rules = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_keys___default()(ops[input].rules);
                        result[input] = {
                            _pass: true
                        };
                        ...
                        var _rules = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_keys___default()(ops[input].rules);
                        result[input] = {
                            _pass: false
                        };
        ...
        methods: {
            validate: function validate(input) {
                ...
                if (typeof ops[input].form !== 'undefined') {
                    data = __WEBPACK_IMPORTED_MODULE_3_ct_utility___default.a.base.getObjValByKey(this, ops[input].form);
                }
                ruleKeys.map(function (ruleKey) {
                    ...
                    if (rules[ruleKey].async) {
                        ...
                        if (__WEBPACK_IMPORTED_MODULE_3_ct_utility___default.a.base.isRegExp(rule)) {
                            ...
                            result[ruleKey] = rule.call(_this, data);
                        }
                    }
                });
                return result;
            ...
            validateAsync: function validateAsync(input) {
                ...
                if (typeof ops[input].form !== 'undefined') {
                    __WEBPACK_IMPORTED_MODULE_3_ct_utility___default.a.base.getObjValByKey(this, ops[input].form);
                }
                return firstRule.call(this, data).then(function (res) {
